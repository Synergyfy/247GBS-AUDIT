...
import { ArrowRight, Gift, Percent, PoundSterling, Info } from "lucide-react";
import {
    Tooltip,
    TooltipContent,
    TooltipProvider,
                        ...
                        <TooltipProvider>
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <Label htmlFor="maxRewardValue" className="flex items-center gap-2">
                                        Max Reward Value (£)
                                        <Tooltip>
                                            ...
                                            <TooltipContent>
                                                <p>The maximum dollar value you are willing to give away per transaction.</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </Label>
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            className="pl-9 bg-white/50 border-orange-200/30 transition-all focus:border-orange-500/50 focus:bg-white/80 input-glow"
                                        />
                                    </div>
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="minCashComponent" className="flex items-center gap-2">
                                        ...
                                        <Tooltip>
                                            ...
                                            <TooltipContent>
                                                <p>The precise amount a customer MUST pay in cash/card (to cover costs).</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </Label>
                                    <div className="relative">
